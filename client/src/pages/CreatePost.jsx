...
const CreatePost = () => {
  ...
  //redirect to login page for anyone who isnt logged in
  useEffect(()=>{
    if(!token){
      navigate('/login')
    }
...
const POST_CATEGORIES=["Agriculture","Business","Education", "Entertainment","Art","Sports","Weather","Uncategorized"]
